...
H_ANGLE_DEG: float = 1.0       # horizontal inward angle of EACH camera (degrees) — cameras face straight ahead, no toe-in
V_ANGLE_DEG: float = 45.0      # vertical upward angle of EACH camera (degrees)
